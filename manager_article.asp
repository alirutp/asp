...
<%
tmp=ap_query("SELECT article.id,article.title,article.author,sort.sort_name,article.add_time,article.read_num FROM article,sort where article.sort_id=sort.sort_id  and article.status_id=1 ORDER BY article.id")
